...
export function ComicSlider({ id }: TCharIdParam) {
    ...
    const handleMouseMove = (e: React.MouseEvent<HTMLDivElement>) => {
        ...
        const boundedPosition = Math.max(0, Math.min(maxThumbPosition.current, newThumbPosition))
        const scrollPosition = (boundedPosition / maxThumbPosition.current) * maxScrollLeft.current
